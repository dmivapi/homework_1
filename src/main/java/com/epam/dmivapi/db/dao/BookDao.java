...
import com.epam.dmivapi.db.DaoUtil;
import com.epam.dmivapi.db.EntityMapper;
import com.epam.dmivapi.db.entity.Author;
import com.epam.dmivapi.db.entity.Book;
import com.epam.dmivapi.db.entity.Genre;
import com.epam.dmivapi.db.entity.Publisher;
...
public class BookDao {
    ...
    public static List<Book> findBooks(String languageCode, String title, String author,
        ...
        try {
            ...
            pstmt = fillPStatement(con, languageCode, title, author, orderByField, asc,
    ...
    */
    public static Integer findBookCopyIdByPublication(Connection con, int publicationId) throws SQLException {
